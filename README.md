...
Official JAX implementation of **NeurIPS 2025** paper "[Generation as Search Operator for Test-Time Scaling of Diffusion-Based Combinatorial Optimization](https://openreview.net/forum?id=9JM03CQwzC)". A PyTorch version will be released soon.
